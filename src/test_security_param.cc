...
int main(int argc, char** argv)
{
    ...
    for(int iter=0;iter<9;iter++){
        ...
        for(int i=0;i<TRIALS;i++)
        {
            #if defined(BLACKH19)
            {
                ZKP_Prover_Vector_BlackH19 prover(P,Commitments,LOC);
                ZKP_Verifier_Vector_BlackH19 verifier(P,Commitments,security_param);
        ...
        {
            #if defined(BLACKH19)
            cout<<BLACKH19_PROVER_TAGS[i]<<","<<security_param;
        ...
        {
            #if defined(BLACKH19)
            cout<<BLACKH19_VERIFIER_TAGS[i]<<","<<security_param;
            for(int j=0;j<TRIALS;j++)
            {
