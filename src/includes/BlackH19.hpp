...
/* Class: ZKP_Prover_Vector_BlackH19 
 *
...
class ZKP_Prover_Vector_BlackH19{
    ...
    public:
         ...
         */
        ZKP_Prover_Vector_BlackH19(Pedersen &P, vector<Pedersen_Commitment> Commitments, uint location);

        /*Method: Deconstructor
         *
         * Frees memory that is used by this object
         */
        ~ZKP_Prover_Vector_BlackH19();
...
/* Class: ZKP_Verifier_Vector_BlackH19 
 *
 * This class uses the idea that if f(t)=t^j, and is the polynomial of the witnesses than is it is probably a one-hot vector
 * This is an iterface for using this protocol and designed to be run along side the verifier subject to this order
 *  1)get_t_challenge
...
class ZKP_Verifier_Vector_BlackH19{
    ...
    public:
         ...
         */
        ZKP_Verifier_Vector_BlackH19(Pedersen &P, vector<Pedersen_Commitment> Commitments,uint lambda);

        /* Method: deconstructor
         *
         * Frees the memory that is used by this protocol
         */
        ~ZKP_Verifier_Vector_BlackH19();
