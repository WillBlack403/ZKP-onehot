...
ZKP_Prover_Vector_BlackH19::ZKP_Prover_Vector_BlackH19(Pedersen &P, vector<Pedersen_Commitment> Commitments, uint location):P(P)
{
...
ZKP_Prover_Vector_BlackH19::~ZKP_Prover_Vector_BlackH19()
{

}

tuple<chrono::duration<double>,chrono::duration<double>,chrono::duration<double>,chrono::duration<double>,chrono::duration<double>> ZKP_Prover_Vector_BlackH19::get_timers()
{
    return make_tuple(creation_timer,set_t_timer,get_commit_timer,set_challenge_timer,get_verify_timer);
}

void ZKP_Prover_Vector_BlackH19::set_t_challenge(ZZ_p t_challenge)
{
    auto stime=chrono::high_resolution_clock::now();
    //Choose randomness
...
tuple<vector<Pedersen_Commitment>,vector<Pedersen_Commitment>,vector<Pedersen_Commitment>,vector<Pedersen_Commitment>,vector<Pedersen_Commitment>> ZKP_Prover_Vector_BlackH19::get_commitments()
{
    auto stime=chrono::high_resolution_clock::now();
...
tuple<vector<ZZ_p>,vector<ZZ_p>,vector<ZZ_p>,vector<ZZ_p>> ZKP_Prover_Vector_BlackH19::get_verification()
{
    auto stime=chrono::high_resolution_clock::now();
    vector<ZZ_p> v,u,w,z;
    for(uint j=0;j<this->bitlength;j++)
...
void ZKP_Prover_Vector_BlackH19::set_challenge(ZZ_p challenge)
{
    auto stime = chrono::high_resolution_clock::now();
...
ZKP_Verifier_Vector_BlackH19::ZKP_Verifier_Vector_BlackH19(Pedersen &P, vector<Pedersen_Commitment> Commitments,uint lambda):P(P)
{
    auto stime = chrono::high_resolution_clock::now();
    this->Commitments=Commitments;
    this->bitlength=(uint) ceil(log2(this->Commitments.size()+1));
...
ZKP_Verifier_Vector_BlackH19::~ZKP_Verifier_Vector_BlackH19()
{

}


ZZ_p ZKP_Verifier_Vector_BlackH19::get_t_challenge()
{
    return this->t_challenge;
}

ZZ_p ZKP_Verifier_Vector_BlackH19::get_challenge()
{
    return this->challenge;
}

void ZKP_Verifier_Vector_BlackH19::set_commitments(tuple<vector<Pedersen_Commitment>,vector<Pedersen_Commitment>,vector<Pedersen_Commitment>,vector<Pedersen_Commitment>,vector<Pedersen_Commitment>> proof)
{
    auto stime = chrono::high_resolution_clock::now();
    this->proof=proof;
...
void ZKP_Verifier_Vector_BlackH19::set_verification(tuple<vector<ZZ_p>,vector<ZZ_p>,vector<ZZ_p>,vector<ZZ_p>> verification)
{
    auto stime = chrono::high_resolution_clock::now();
...
bool ZKP_Verifier_Vector_BlackH19::accept()
{
    auto stime = chrono::high_resolution_clock::now();
    bn_t bn_challenge;
    bn_new(bn_challenge);
...
tuple<chrono::duration<double>,chrono::duration<double>,chrono::duration<double>,chrono::duration<double>> ZKP_Verifier_Vector_BlackH19::get_timers()
{
